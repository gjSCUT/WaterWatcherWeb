...
function autoWithByData(data) {
	var max =0;
	for(var i=0;i<data.length;i++){
		if(max<data[i]) max=data[i];
	}
	var width = max.toString().length * 10 + 20;
	return [width,50];
}